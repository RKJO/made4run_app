    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ITRA_points', models.SmallIntegerField(blank=True, null=True, verbose_name='ITRA points')),
                ('mountain_level', models.SmallIntegerField(blank=True, null=True, verbose_name='Mountain level')),
